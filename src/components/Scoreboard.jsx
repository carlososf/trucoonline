...
export default function Scoreboard({ roomState, currentPlayer, isMuted, onToggleMute }) {
  ...
  return (
    <header className="w-full flex justify-center items-center pt-2 px-4 z-20">
      <div className="lousa-boteco px-5 py-2 text-slate-100 flex flex-col md:flex-row items-center justify-between gap-4 shadow-2xl rounded-2xl border-4 border-amber-900 max-w-4xl w-full">
        ...
        {/* CENTRO: PLACAR CENTRALIZADO ESTILO LOUSA DE GIZ */}
        <div className="flex items-center gap-6 bg-slate-950/95 px-6 py-1.5 rounded-2xl border-2 border-amber-800/80 shadow-2xl">
          {/* Time 1 */}
          <div className="flex items-center gap-3">
